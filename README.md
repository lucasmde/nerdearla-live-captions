...
[![CI](https://github.com/lucasmde/nerdearla-live-captions/actions/workflows/ci.yml/badge.svg)](https://github.com/lucasmde/nerdearla-live-captions/actions/workflows/ci.yml) · **[Demo pública en vivo](https://nerdearla-live-captions.onrender.com)** · [Video (3 min)](https://youtu.be/35TdPJCY5dw) · [Manual](docs/MANUAL.md) ([PDF](docs/manual.pdf)) · [Evidencia: latencia, escala y costo](docs/EVIDENCIA.md)
...
- **Panel de salas y agenda.** `/admin/sessions` (con login de Google o GitHub) permite crear salas, editarlas y cargar/editar/borrar charlas de la agenda —título, orador, horario, idioma— sin tocar `sessions.json` a mano ni reiniciar el servidor. Los mails de `ADMIN_EMAILS` administran todas las salas; cualquier otra cuenta puede crear y administrar su propia sala de prueba para ver cómo se arma un evento, sin depender de que alguien le dé el alta. Detalle en [docs/MANUAL.md](docs/MANUAL.md#panel-de-salas).
...
- **Eventos agendados con anticipación.** Al crear una sala se le puede poner fecha y hora, aunque sea meses después. La portada las muestra separadas de las que están en vivo, en tarjetas "🗓️ Próximamente" con cuenta regresiva y quién las creó.
